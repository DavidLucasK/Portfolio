...
function translateEnglish() {
    ...
    const traducoes = {
        ...
        'proj10-desc': 'Web site to create notes to remember with Drag&Drop.',
...
function translateSpanish() {
    ...
    const traducoesSpanish = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Sitio web para crear notas para recordar con Drag&Drop.',
...
function translateFrench() {
    ...
    const traducoesFrench = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Site Web pour créer des notes à se souvenir avec Drag&Drop.',
...
function translateJapanese() {
    ...
    const traducoesJapanese = {
        ...
        'proj10-desc': 'ドラッグ＆ドロップで覚えたことをメモするためのウェブサイト。',
        'proj11-title': '子供を救う会',
...
function translatePortuguese() {
    ...
    const traducoesPortuguese = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Site Web para criar Notas para lembrar com Drag&Drop.',
