...
function translateEnglish() {
    ...
    const traducoes = {
        ...
        'proj10-desc': `Website to create notes for reminders with Drag&Drop.<br/>Uses cache to save information for future use.<br/><strong>Currently available only for Desktop</strong>`,
...
function translateSpanish() {
    ...
    const traducoesSpanish = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Sitio web para crear notas para recordatorios con Drag&Drop.<br/>Utiliza caché para guardar información para futuros usos.<br/><strong>Actualmente disponible solo para escritorio</strong>',
...
function translateFrench() {
    ...
    const traducoesFrench = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Site Web pour créer des notes pour des rappels avec Drag&Drop.<br/>Utilise le cache pour sauvegarder les informations pour une utilisation future.<br/><strong>Disponible uniquement pour les ordinateurs de bureau pour le moment</strong>',
...
function translateJapanese() {
    ...
    const traducoesJapanese = {
        ...
        'proj10-desc': 'ドラッグ＆ドロップで覚えたことをメモするためのウェブサイト。<br/>情報を将来の使用のためにキャッシュを利用して保存します。<br/><strong>現時点ではデスクトップ専用です</strong>',
        'proj11-title': '子供を救う会',
