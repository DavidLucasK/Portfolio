...
function translateEnglish() {
    ...
    const traducoes = {
        ...
        'proj2-desc': 'Web app that I made for my girlfriend to have fun and to be something enjoyable between us.<br>I also created a React Native mobile app that uses the same database.<br><strong>*Real-time validations and requests with an API made by me as well.</strong>',
        ...
        'proj11-desc': 'Volunteer work for the Salve uma Criança Institute, which carries out social actions in Campinas, transforming special dates and bringing hope to children.',
...
function translateSpanish() {
    ...
    const traducoesSpanish = {
        ...
        'proj2-desc': 'Aplicación web que hice para que mi novia pueda divertirse y sea algo entretenido entre nosotros.<br>También hice una aplicación móvil en React Native que usa la misma base de datos.<br><strong>*Validaciones y solicitudes en tiempo real con una API hecha por mí también.</strong>',
        ...
        'proj11-desc': 'Trabajo voluntario para el Instituto Salve una Criança, que realiza acciones sociales en Campinas, transformando fechas especiales y llevando esperanza a los niños.',
...
function translateJapanese() {
    ...
    const traducoesJapanese = {
        ...
        'proj2-desc': '彼女が楽しめるように、そして私たちの間で楽しいものになるように作ったウェブアプリです。<br>同じデータベースを使用するReact Nativeのモバイルアプリも作成しました。<br><strong>＊APIを自作し、リアルタイムでのバリデーションとリクエストも実現しました。</strong>',
        ...
        'proj11-title': '子供を救う会',
        'proj11-desc': 'カンピーナスで特別な日を変え、子供たちに希望をもたらす社会的活動を行うサルヴ・ウマ・クリアンサ・インスティチュートのボランティア活動。',
        'footer-title': '連絡先',
...
function translatePortuguese() {
    ...
    const traducoesPortuguese = {
        ...
        'proj2-desc': 'App web que fiz para minha namorada poder brincar e ser algo divertido entre a gente.<br>Também fiz um aplicativo mobile em React Native que usa a mesma base de dados.<br><strong>*Validações e requisições em tempo real com API feita por mim também.</strong>',
        ...
        'proj11-desc': 'Trabalho voluntário para o Instituto Salve uma Criança, que realiza ações sociais em Campinas, transformando datas especiais e levando esperança às crianças.',
