...
function translateEnglish() {
    ...
    const traducoes = {
        ...
        'proj10-desc': 'Website to create notes for reminders with Drag&Drop.<br/>Currently available only for Desktop.',
...
function translateSpanish() {
    ...
    const traducoesSpanish = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Sitio web para crear notas para recordatorios con Drag&Drop.<br/>Actualmente disponible solo para escritorio.',
...
function translateFrench() {
    ...
    const traducoesFrench = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Site Web pour créer des notes pour des rappels avec Drag&Drop.<br/>Disponible uniquement pour les ordinateurs de bureau pour le moment.',
...
function translateJapanese() {
    ...
    const traducoesJapanese = {
        ...
        'proj10-desc': 'ドラッグ＆ドロップで覚えたことをメモするためのウェブサイト。<br/>現時点ではデスクトップ専用です。',
        'proj11-title': '子供を救う会',
...
function translatePortuguese() {
    ...
    const traducoesPortuguese = {
        ...
        'proj10-title': 'Drag & Notes',
        'proj10-desc': 'Site Web para criar Notas para lembrar com Drag&Drop.<br/>Somente para Desktop no momento',
